<?php
	...
	$sql = "select * from student where S_Id = '$email' and Password='$passd'";
...
<div id="color">
	...
	<header>
		...
		&#9993;<a href="mailto:avinashpatelacs@gmail.com" style="text-align:right color:white ;text-decoration: none; color:white" >vijaymishravm99@gmail.com</a>&nbsp;&nbsp;
		&#9743;<a href="Mobile:8301006533" style="text-align:right; text-decoration: none;color:white">8009031061</a>
...
<table border="0" align="center">
	<tr><td></td><td><h3><u>Login Student</u></h3></td></tr>
  <tr>
    <td>User Name</td>
    <td>
      <input type="text" name="stuid" size="30" placeholder="Student-Id" required>
    </td>
  </tr>
  <tr>
    <td>Password</td>
